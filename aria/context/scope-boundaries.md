...
- Blocos 0-7 are the Aria Core MVP and local tag `v0.1.0` exists. Blocos 8-23 are post-core feature expansion. Do not start post-core implementation without a dedicated spec.
