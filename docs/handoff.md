...
Blocos 15-17 status: implemented. Internet radio foundation, stream quality/transcoding/network policy, playback capability models, and fade capability follow-up are model/policy/readiness-only. Audit 14-17 is complete.

Blocos 18-21 status: implemented. Audit 18-20 is deferred to the final post-core/core audit, and Audit 21-23 is deferred unless explicitly requested.
